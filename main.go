...
func main() {
	...
	flag.StringVar(&parameters.webhookCfgFile, "webhookCfgFile", "/etc/webhook/config/webhookConfig.yaml", "File containing the mutation configuration.")
	flag.Parse()
	...
	glog.Info("Auto removing volume mounts to path(s): ", webhookConfig.RemoveMountsToPaths)
	...
	mux.HandleFunc("/healthcheck", whsvr.healthcheck)
